# -*- coding: utf-8 -*-
"""
Created on Thu Aug 08 16:20:10 2018
...
class MongoConnector:
    ...
    def create_index(self, index_field_name='inserted_timestamp', expire_time_seconds=constants.EXPIRE_TIME):
    ...
    def update_document(self, update_spec, document):
        self.collection.update(update_spec, document)
